...
def main():
    debug = False
    case_studies = [820, 835, 850, 420, 435, 450, 805, 405]
    for cs in case_studies:
        ...
        if not os.path.exists(f"kmeans/{case_study}"):
            os.makedirs(f"kmeans/{case_study}")
        ...
        for mission in range(10):
            ...
            with open(f"kmeans/{case_study}/decision_time_{mission}.csv", 'w', newline='') as file:
                writer = csv.writer(file)
                for tm in decision_time:
                    writer.writerow([tm])

            with open(f"kmeans/mission_time_{case_study}.csv", 'w', newline='') as file:
                writer = csv.writer(file)
                for tm in arr_req:
                    writer.writerow([tm])

            with open(f"kmeans/decision_time_{case_study}.csv", 'a', newline='') as file:
                writer = csv.writer(file)
